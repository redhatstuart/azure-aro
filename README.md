...
```
* [https://github.com/Azure/ARO-RP/blob/master/docs/using-az-aro.md](https://github.com/Azure/ARO-RP/blob/master/docs/using-az-aro.md)
```
...
```
* [https://github.com/jmo808/arm-aro43](https://github.com/jmo808/arm-aro43)
```
